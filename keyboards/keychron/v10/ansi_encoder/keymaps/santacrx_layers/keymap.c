...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NUM] = LAYOUT_ansi_89(
        KC_MS_BTN1,  _______,  		RGB_HUD,  	   RGB_HUI,  	   RGB_SAD,  RGB_SAI,  RGB_VAD,   RGB_VAI,  RGB_RMOD,  RGB_MOD,   KC_NO,  	KC_NO,    KC_NO,   KC_NO,   _______,            _______,
...
void eeconfig_init_user(void) {  // EEPROM is getting reset!
  ...
  rgb_matrix_sethsv(HSV_WHITE);  // Set it to white by default
